...
/**
* A geocoder component using MapLibre Geocoding API
* @class MaplibreGenericGeocoder
*
...
* @return {MaplibreGenericGeocoder} `this`
*/
function MaplibreGenericGeocoder(options, geocodeRequest) {
	this._eventEmitter = new EventEmitter();
	this.options = extend({}, this.options, options);
	this.geocodeRequest = geocodeRequest;
}

MaplibreGenericGeocoder.prototype = {
	...
	onAdd: function(map) {
		...
		el.className = 'maplibregl-ctrl maplibregl-ctrl-generic-geocoder maplibregl-ctrl-group';
	...
	_onChange: function() {
		...
		* @returns {MaplibreGenericGeocoder} this;
		*/
		on: function(type, fn) {
	...
	module.exports = MaplibreGenericGeocoder;
